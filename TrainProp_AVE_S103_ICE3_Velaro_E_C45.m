...
Train.Veh(veh_num).Body.m = 41200;                        % Main body mass [kg]
Train.Veh(veh_num).Body.I = 1687552;                      % Main body mass moment of inertia [kg*m^2]
...
Train.Veh(veh_num).Bogie.I = [1,1]*1372;                  % Bogies mass moments of inertia [kg*m^2]
