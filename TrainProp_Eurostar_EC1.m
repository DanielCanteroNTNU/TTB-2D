...
Train.Veh(veh_num).Body.m = 35860;                        % Main body mass [kg]
Train.Veh(veh_num).Body.I = 1658000;                      % Main body mass moment of inertia [kg*m^2]
...
Train.Veh(veh_num).Body.Le = [1,1]*(22.5-Train.Veh(veh_num).Body.L);                % Additional distance [m], front and back
...
Train.Veh(veh_num).Susp.Sec.k = [1,1]*90e3;               % Secondary suspension stiffness [N/m]
